...
int main() {
    double M = 5.9; // Значение массы центрального тела(планеты)
    double e = 0.008; // Эксцентриситет орбиты
    ...
    // Часть 1. Метод итераций (метод неподвижной точки или метод последовательных приближений)
    ...
    // Часть 4. Метод Ньютона (метод касательных)
